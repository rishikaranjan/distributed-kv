...
const file_raft_proto_rawDesc = "" +
	...
	"\fvote_granted\x18\x01 \x01(\bR\vvoteGranted2\x9b\x01\n" +
	"\vRaftService\x12H\n" +
	"\rAppendEntries\x12\x1a.raft.AppendEntriesRequest\x1a\x1b.raft.AppendEntriesResponse\x12B\n" +
	"\vRequestVote\x12\x18.raft.RequestVoteRequest\x1a\x19.raft.RequestVoteResponseB\x1aZ\x18distributed-kv/raft;raftb\x06proto3"
